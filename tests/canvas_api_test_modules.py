...
def get_course_modules(canvas_base_url: str, access_token: str, course_id: str):
    """
    ...
    print(f"Attempting to fetch modules for course {course_id} from {api_url} with params {params}")
